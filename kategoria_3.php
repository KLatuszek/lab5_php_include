...
<section>
  ...
  <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in pulvinar nunc. Aliquam bibendum eros felis, et dictum leo hendrerit ac. Morbi non tincidunt quam. Sed quam felis, gravida quis quam vel, semper viverra massa. Suspendisse id metus porta enim scelerisque congue sed sed tortor. Suspendisse congue tincidunt eros vitae iaculis. Nam sed odio eget sem porttitor consequat. Sed id rhoncus dolor. Suspendisse molestie vestibulum lacus, et volutpat erat mattis at.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in pulvinar nunc. Aliquam bibendum eros felis, et dictum leo hendrerit ac. Morbi non tincidunt quam. Sed quam felis, gravida quis quam vel, semper viverra massa. </p>
    ...
    <div style="width:300px; height:400px; margin:0px auto; float:center;text-align: center">
    <p class="text-center"><strong>120zl </strong></p><br>
   <a class="example-image-link" href="http://lokeshdhakar.com/projects/lightbox2/images/image-3.jpg" data-lightbox="example-3" data-title="Optional caption."><img class="example-image" src="Produkt3img.jpg" alt="image-1"/></a>
